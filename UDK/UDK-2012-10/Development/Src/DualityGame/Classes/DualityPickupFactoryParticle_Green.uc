class DualityPickupFactoryParticle_Green extends DualityPickupFactory
placeable;
...
defaultproperties
{
	...
	Begin Object Class=StaticMeshComponent Name=GreenPickUpMesh
    	StaticMesh=StaticMesh'Duality.Meshes.PS_GREEN'
	 	CastShadow=FALSE
