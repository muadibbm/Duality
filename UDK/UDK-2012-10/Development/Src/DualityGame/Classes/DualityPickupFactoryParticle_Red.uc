class DualityPickupFactoryParticle_Red extends DualityPickupFactory
placeable;
...
defaultproperties
{
	...
	Begin Object Class=StaticMeshComponent Name=RedPickUpMesh
    	StaticMesh=StaticMesh'Duality.Meshes.PS_RED'
	 	CastShadow=FALSE
